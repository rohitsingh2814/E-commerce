<footer class="bg-gray-900 text-white  pb-10  pt-20 px-6">
    <div class="max-w-6xl mx-auto grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-8">
        
        <!-- Store Location -->
        <div>
            <h2 class="font-semibold text-lg">Store Location</h2>
            <p class="mt-2 text-gray-400">LPU Unimall block-14</p>
            <p class="text-gray-400">Jalandhar,chehru, IN 144023</p>
            <p class="text-gray-400">rohitsingh7667.com</p>
    ...
    <div class="mt-10 text-center">
        <p class="text-gray-400">We accept the following payment methods</p>
        <div class="flex justify-center space-x-5 mt-3">
            <img src="https://upload.wikimedia.org/wikipedia/commons/0/04/Visa.svg" class="h-8">
            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" class="h-8">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Commons-logo.svg/960px-Commons-logo.svg.png?20140603134345" class="h-8">
